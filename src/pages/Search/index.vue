    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">{{searchParams.categoryName}}<i @click="removeCateforyName">×</i></li>
            <!-- 关键字面包屑 -->
            <li class="with-x" v-if="searchParams.keyword">{{searchParams.keyword}}<i @click="removeKeyword">×</i></li>
            <!-- 品牌面包屑 -->
            <li class="with-x" v-if="searchParams.trademark">{{searchParams.trademark.split(":")[1]}}<i @click="removeTrademark">×</i></li>
            <!-- 参数面包屑 -->
            <li class="with-x" v-for="(item,index) in searchParams.props" :key="index">{{item.split(":")[1]}}<i @click="removeAttrInfo(index)">×</i></li>
          </ul>
        </div> 
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="good in goodsList" :key="good.id">
                <div class="list-wrap">
                  ...
                  <div class="operate">
                    <a href="#" target="_blank" class="sui-btn btn-bordered btn-danger" @click.prevent="addCart(good)">加入购物车</a>
  ...
  export default {
    ...
    methods: {
      async addCart(good){
          ...
          sessionStorage.setItem("attrInfo",JSON.stringify(""));
          this.$router.push({
            name: "addCartSuccess",
            query: { skuNum: 1 }
          });
      ...
      //排序
      changeOrder:throttle(function(flag){
